...
void print_store(char* name, Instruction instruction)
{
    ...
    printf(MEM_FORMAT, name, instruction.stype.rs2, sign_extend_number(get_store_offset(instruction), 12), instruction.stype.rs1);
}

void print_branch(char* name, Instruction instruction)
{
    /* YOUR CODE HERE */
    printf(BRANCH_FORMAT, name, instruction.sbtype.rs1, instruction.sbtype.rs2, sign_extend_number(get_branch_offset(instruction), 12));
}
