...
# helper functions
.globl file_error, print_int_array, print_coo_array, malloc, free, print_num_alloc_blocks, num_alloc_blocks
...
#================================================================
# void print_coo_array(int* a0, int a1)
# Prints an integer array, with spaces between the elements
# args:
#   a0 is the pointer to the start of the array
#   a1 is the # of nnzs. 
#   Each element in array is a struct {int row, int col, int val}
# return:
#   void
#================================================================
print_coo_array:
